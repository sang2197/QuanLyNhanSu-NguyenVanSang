...
- [`UserStories_SalaryGradePromotion.md`](UserStories_SalaryGradePromotion.md) — User stories with business rules and acceptance criteria (Given/When/Then) for the review-and-decision workflow.
- [`UseCase_SalaryGradePromotion.md`](UseCase_SalaryGradePromotion.md) — Use case diagram and description (actors and main actions), aligned with the user stories above.
