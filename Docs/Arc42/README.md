...
Architecture documentation for the HRM System (Salary Grade Promotion feature), following the [arc42](https://arc42.org/) template — one file per section, as recommended by the [arc42-toolkit](https://github.com/MSiccDev/arc42-toolkit) so the automated `arc42-lint` check can run against it.
